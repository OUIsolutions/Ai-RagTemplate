...
function Install_dependencies()
    ...
    local libs = {
        ...
        { url = "https://github.com/SamuelHenriqueDeMoraisVitrio/ClientSDKOpenAI/releases/download/0.0.7/SDK_OpenAI.c", path = "dependencies/SDK_OpenAI.c" },
        { url = "https://github.com/SamuelHenriqueDeMoraisVitrio/ClientSDKOpenAI/releases/download/0.0.7/SDK_OpenAI.h", path = "dependencies/SDK_OpenAI.h" },
    }
